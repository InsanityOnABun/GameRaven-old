    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findPreference("donate").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                db.setPositiveButton("Donate", new DialogInterface.OnClickListener() {
                    @Override
        ...
        findPreference("resetAccentColor").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                Crouton.showText(SettingsMain.this, "Accent color reset.", Theming.croutonStyle());
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            try {
                ...
                for (String s : AccountManager.getUsernames(this)) {
                    ...
                    buf.append(s + "\n");
                    buf.append(AccountManager.getPassword(this, s) + "\n");
                ...
                buf.close();
                Crouton.showText(this, "Backup done.", Theming.croutonStyle());
            ...
            Crouton.showText(this, "Backup failed. External storage is most likely not accessible.", Theming.croutonStyle());
        }
    }
...
//					Crouton.showText(this, "Restore done.", MainActivity.getCroutonStyle());
                    ...
                    e.printStackTrace();
                    Crouton.showText(this, "Settings file is corrupt.", Theming.croutonStyle());
                }
            } else {
                Crouton.showText(this, "Settings file not found.", Theming.croutonStyle());
            }
        } else {
            // Something else is wrong. It may be one of many other states, but all we need
            //  to know is we can neither read nor write
            Log.e("writeToLog", "error writing to log, external storage is not writable");
            Crouton.showText(this, "Restore failed. External storage is most likely not accessible.", Theming.croutonStyle());
        }
    }
    ...
    private Dialog createModifySigDialog() {
        ...
        b.setNeutralButton("Clear Sig", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Crouton.showText(SettingsMain.this, "Signature cleared and saved.", Theming.croutonStyle());
            }
        });
                    ...
                    public void onClick(View view) {
                        ...
                        if (length < 161) {
                            if (lines < 2) {
                                ...
                                Crouton.showText(SettingsMain.this, "Signature saved.", Theming.croutonStyle());
                                d.dismiss();
                            } else
