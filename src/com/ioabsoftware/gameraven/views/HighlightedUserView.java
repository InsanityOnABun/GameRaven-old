...
//				new ColorSelectorDialog(hlActivity,
//						new OnColorChangedListener() {
//							@Override
//							public void colorChanged(int newColor) {
//								dSetColor.setBackgroundColor(newColor);
//								dSetColor.setTextColor(~newColor | 0xFF000000); //without alpha
//								dColorVal.setText(Integer.toString(newColor));
//							}
//						}, 
//						startColor).show();
			}
